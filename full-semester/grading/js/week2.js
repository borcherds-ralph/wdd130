...
function buildReport(data, url) {
    ...
    return `<main>
     <h3>w3.org Validation Tools</h3>
      ...
      <div class="data">${c.includes(":root {") || c.includes(":root{") ? "✅" : "❌"
        }</div>
      <div class="standard"></div>
      ...
      <div class="data">${c.includes("XXXXXX") || c.includes("______") ? "❌" : "✅"
        }</div>
      ...
      <div class="data">${c.includes("body {") || c.includes("body{") ? "✅" : "❌"
        }</div>
